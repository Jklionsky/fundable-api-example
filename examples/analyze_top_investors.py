...
def example_1_top_seed_investors():
    ...
    This is the primary use case - find most active early-stage investors.
    """
    print("\n" + "="*80)
...
def example_5_combined_filters():
    ...
    """
    print("\n" + "="*80)
    print("EXAMPLE 5: Top Early-Stage Tech Investors (Combined Filters)")
    print("="*80)
    ...
    analyzer.print_results(results, "Top 15 Early-Stage Tech Investors")
    
    os.makedirs('output', exist_ok=True)
    analyzer.save_results(results, 'output/top_early_stage_tech.json')
...
def main():
    ...
    print("💡 To run other examples, edit analyze_top_investors.py and uncomment")
